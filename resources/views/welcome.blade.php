    ...
    <div class="container">
        ...
        <div class="jumbotron">
				<div class="jumbotron-text">
					<h1 style="color: #101010;">Temukan Tempat Wisata Favorit</h1>
					<p>Temukan tempat wisata favoritmu dengan mudah dan cepat. Dapatkan penawaran menarik setiap harinya.</p>
				</div>
                    ...
                    @foreach ($categories as $data)
                            ...
                            <div class="modal-dialog" onclick="event.stopPropagation()">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title " style="color:  #007bff;">Formulir Pembayaran</h1>
                        ...
                        <div id="myModal2{{ $data->id_categories }}" class="modal-container"
                            ...
                            <div class="modal-dialog" onclick="event.stopPropagation()">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title" style="color:  #007bff;">Data Transaksi</h1>
